...
public class GlobalExceptionHandler {
    ...
    /** @Validated method-parameter constraints (e.g. GET /schools/search?q= too short) — not
     *  covered by MethodArgumentNotValidException, which only fires for @Valid @RequestBody. */
